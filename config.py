...
DASH_V2_COMPARE_SOURCE_TRUTH_TOTAL_TIMEOUT_SECONDS = max(
    DASH_V2_COMPARE_SOURCE_TRUTH_TIMEOUT_SECONDS,
    float(os.getenv("DASH_V2_COMPARE_SOURCE_TRUTH_TOTAL_TIMEOUT_SECONDS", "60.0")),
)
