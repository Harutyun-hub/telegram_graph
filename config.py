...
OPENCLAW_WEBSITE_SESSION_KEY = os.getenv(
    "OPENCLAW_WEBSITE_SESSION_KEY",
    "" if IS_PRODUCTION else "tg-analyst-ru-website-monitor",
).strip()
...
QUESTION_BRIEFS_USE_AI_TRIAGE = _env_bool("QUESTION_BRIEFS_USE_AI_TRIAGE", True)
...
QUESTION_BRIEFS_PROMPT_VERSION = os.getenv("QUESTION_BRIEFS_PROMPT_VERSION", "qcards-v3")
...
BEHAVIORAL_BRIEFS_PROMPT_VERSION = os.getenv("BEHAVIORAL_BRIEFS_PROMPT_VERSION", "behavior-v3")
...
OPPORTUNITY_BRIEFS_MIN_CONFIDENCE = float(os.getenv("OPPORTUNITY_BRIEFS_MIN_CONFIDENCE", "0.55"))
...
OPPORTUNITY_BRIEFS_PROMPT_VERSION = os.getenv("OPPORTUNITY_BRIEFS_PROMPT_VERSION", "opportunity-v2")
...
SCRAPE_MAX_POSTS_PER_SOURCE_PER_CYCLE = max(0, int(os.getenv("SCRAPE_MAX_POSTS_PER_SOURCE_PER_CYCLE", "0")))
SCRAPE_MAX_COMMENT_POSTS_PER_SOURCE_PER_CYCLE = max(
    1,
    int(os.getenv("SCRAPE_MAX_COMMENT_POSTS_PER_SOURCE_PER_CYCLE", "20")),
)
...
SOCIAL_WEBSITE_MONITOR_ENABLED = _env_bool("SOCIAL_WEBSITE_MONITOR_ENABLED", True)
SOCIAL_WEBSITE_MONITOR_CRON_ENABLED = _env_bool("SOCIAL_WEBSITE_MONITOR_CRON_ENABLED", True)
SOCIAL_WEBSITE_MONITOR_CRON_TIMEZONE = os.getenv("SOCIAL_WEBSITE_MONITOR_CRON_TIMEZONE", "Asia/Yerevan").strip() or "Asia/Yerevan"
SOCIAL_WEBSITE_MONITOR_CRON_HOUR = max(0, min(23, int(os.getenv("SOCIAL_WEBSITE_MONITOR_CRON_HOUR", "2"))))
SOCIAL_WEBSITE_MONITOR_CRON_MINUTE = max(0, min(59, int(os.getenv("SOCIAL_WEBSITE_MONITOR_CRON_MINUTE", "0"))))
SOCIAL_WEBSITE_MONITOR_LIMIT = max(1, int(os.getenv("SOCIAL_WEBSITE_MONITOR_LIMIT", "10")))
SOCIAL_WEBSITE_MONITOR_INTERVAL_HOURS = max(1, int(os.getenv("SOCIAL_WEBSITE_MONITOR_INTERVAL_HOURS", "24")))
SOCIAL_WEBSITE_RESEARCH_MAX_PAGES = max(1, int(os.getenv("SOCIAL_WEBSITE_RESEARCH_MAX_PAGES", "8")))
SOCIAL_WEBSITE_RESEARCH_PROMPT_VERSION = os.getenv(
    "SOCIAL_WEBSITE_RESEARCH_PROMPT_VERSION",
    "website-promotion-v2",
).strip() or "website-promotion-v2"
SOCIAL_WEBSITE_PROMOTION_MAX_ITEMS = max(1, int(os.getenv("SOCIAL_WEBSITE_PROMOTION_MAX_ITEMS", "12")))
SOCIAL_WEBSITE_PROMOTION_EXPIRE_AFTER_MISSES = max(
    1,
    int(os.getenv("SOCIAL_WEBSITE_PROMOTION_EXPIRE_AFTER_MISSES", "3")),
)
OPENCLAW_WEBSITE_RESEARCH_TIMEOUT_SECONDS = float(os.getenv("OPENCLAW_WEBSITE_RESEARCH_TIMEOUT_SECONDS", "60"))
OPENCLAW_WEBSITE_RESEARCH_RETRY_ATTEMPTS = max(
    0,
    int(os.getenv("OPENCLAW_WEBSITE_RESEARCH_RETRY_ATTEMPTS", "1")),
)
