...
QUESTION_BRIEFS_TRIAGE_MODEL = os.getenv("QUESTION_BRIEFS_TRIAGE_MODEL", "gpt-4o-mini")
...
QUESTION_BRIEFS_SYNTHESIS_MODEL = os.getenv("QUESTION_BRIEFS_SYNTHESIS_MODEL", "gpt-4o")
...
QUESTION_BRIEFS_WINDOW_DAYS = int(os.getenv("QUESTION_BRIEFS_WINDOW_DAYS", "30"))
...
BEHAVIORAL_BRIEFS_MODEL = os.getenv("BEHAVIORAL_BRIEFS_MODEL", "gpt-4o-mini")
...
BEHAVIORAL_BRIEFS_WINDOW_DAYS = int(os.getenv("BEHAVIORAL_BRIEFS_WINDOW_DAYS", "30"))
...
BEHAVIORAL_BRIEFS_PROMPT_VERSION = os.getenv("BEHAVIORAL_BRIEFS_PROMPT_VERSION", "behavior-v1")
