          ...
          <div className="flex flex-col gap-5 border-b border-slate-200 px-6 py-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-medium text-blue-700">
                ...
                {ru ? 'Social media activities' : 'Social media activities'}
              </div>
              <div>
                <h1 className="text-2xl font-semibold tracking-tight text-slate-900">
                  {ru ? 'Социальная активность компаний' : 'Company social activity intelligence'}
                </h1>
                <p className="mt-1 max-w-3xl text-sm text-slate-600">
                  {ru
                    ? 'Отдельный evidence-first поток для Facebook Ads Library, Instagram и Google Ads с AI-анализом и отдельной social graph проекцией.'
                    : 'A separate evidence-first workflow for Facebook Ads Library, Instagram, and Google Ads with AI enrichment and its own social graph projection.'}
                </p>
              </div>
            </div>
